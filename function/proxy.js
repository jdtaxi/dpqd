...
const bdy_0x432ab3 = process.env.DY_PROXY_REDELAY ? process.env.DY_PROXY_REDELAY : "1";
const bdy_0x350213 = process.env.DY_PROXY ? process.env.DY_PROXY : "";
const bdy_0x4ecc12 = process.env.DY_SOCKS;
const bdy_0x4ceb29 = process.env.DY_PNUM || "3";
const bdy_0x3b2069 = process.env.PERMIT_API ? (process.env.PERMIT_API + "&test").split("&") : "";
const bdy_0x4243eb = true;
let bdy_0x34dadf = 1;
let bdy_0x59a205 = [];
let bdy_0x3fef44 = [];
if (bdy_0x350213) {
...
async function bdy_0x105341() {
  ...
  let _0x4aacc4;
  let _0x2efd36 = bdy_0x59a205[Math.floor(Math.random() * bdy_0x59a205.length)];
